...
SOURCES = src/main.cpp src/locacao.cpp src/formatacao.cpp src/Cliente/cliente.cpp src/Filme/bluray.cpp src/Filme/dvd.cpp src/Filme/fita.cpp src/Filme/filme.cpp src/sistema.cpp
